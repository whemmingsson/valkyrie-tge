...
You are currently using the Valkyrie Shell. To run a game, place the game file in the 'games' directory and run the shell. The shell will automatically detect the game and run it.
