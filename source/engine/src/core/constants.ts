interface Constants {
    EVENT_CONDITIONS_ITEM_IN_INVENTORY: string;
    EVENT_CONDITIONS_IS_LOCKED: string;
    EVENT_CONDITIONS_HAVE_KEY: string;
    EVENT_ACTION_UNLOCK: string;
...
constants.EVENT_ACTION_UNLOCK = "UNLOCK";
...
constants.EVENT_CONDITIONS_HAVE_KEY = "HAVE_KEY";
constants.EVENT_CONDITIONS_IS_LOCKED = "IS_LOCKED";
constants.EVENT_CONDITIONS_ITEM_IN_INVENTORY = "ITEM_IN_INVENTORY";
